      ...
      <div className="w-full min-h-screen py-16 bg-leetcode-bg">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mb-8 text-center">
            ...
            <div className="mx-auto mt-2 h-5 w-96 animate-pulse rounded-lg bg-gray-200"></div>
          </div>

          {/* Stats Cards Skeleton */}
          <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="rounded-lg border-2 border-gray-300 bg-white p-6 shadow-lg">
                <div className="h-4 w-20 animate-pulse rounded bg-gray-200"></div>
                <div className="mt-4 h-10 w-24 animate-pulse rounded bg-gray-200"></div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-6 rounded-lg border-2 border-gray-300 bg-white p-6 shadow-lg">
            <div className="mb-4 h-6 w-32 animate-pulse rounded bg-gray-200"></div>
            <div className="space-y-3">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="flex items-center justify-between rounded-lg border border-gray-300 bg-white p-4">
